...
export default {
    ...
    featureImage: {
        ...
        caption: "Design thinking and innovation consulting practice"
    },
    ...
    process: [
        {
            ...
            content: [
                "Conducted comprehensive design thinking workshops and research sessions",
                "Interviewed stakeholders to understand innovation challenges and opportunities",
                "Analyzed existing processes and identified improvement areas"
            ],
            images: [
                {
            ...
            outcomes: [
                "Identified key innovation opportunities",
                "Mapped user needs and pain points",
                "Defined design thinking approach"
            ]
        },
        {
            title: "Design & Implementation",
            content: [
                "Facilitated design thinking workshops and innovation sessions",
                "Created comprehensive design process frameworks and methodologies",
                "Developed case studies and best practices documentation",
                "Implemented human-centered design principles across projects"
            ],
            images: [
                {
            ...
            outcomes: [
                "Enhanced design thinking capabilities",
